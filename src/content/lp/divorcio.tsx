...
export const divorcioContent: LpContent = {
  ...
  // Desceu o foco: rostos das duas sócias visíveis
  heroObjectPosition: "38% 28%",
  ...
  formFields: [
    {
      ...
      options: [
        { value: "casado_pensando", label: "Ainda casada(o), pensando em me separar" },
        { value: "separado_sem_processo", label: "Já separada(o), sem processo iniciado" },
        { value: "consensual_negociacao", label: "Divórcio consensual em negociação" },
        { value: "litigioso_andamento", label: "Divórcio litigioso em andamento" },
        { value: "processo_travado", label: "Processo iniciado mas travado" },
      ],
    },
    {
      id: "resolver",
      ...
      options: [
        ...
        { value: "divorcio_com_sem_partilha", label: "Divórcio (com ou sem partilha)" },
        { value: "apenas_pensao", label: "Apenas pensão alimentícia" },
        { value: "apenas_guarda", label: "Apenas guarda / visitas" },
        { value: "nao_certeza", label: "Ainda não tenho certeza" },
      ],
    },
    {
      id: "patrimonio",
      label: "Patrimônio a partilhar (pode marcar mais de um)",
      type: "multiselect",
      required: true,
      options: [
        { value: "imoveis", label: "Imóveis" },
        { value: "empresa", label: "Empresa ou participações" },
        { value: "aplicacoes", label: "Aplicações e investimentos" },
        { value: "veiculos", label: "Veículos" },
        { value: "sem_patrimonio_significativo", label: "Sem patrimônio significativo" },
    ...
    },
    {
      ...
      options: [
        ...
        { value: "10k_30k", label: "R$ 10.000 a R$ 30.000" },
        { value: "30k_60k", label: "R$ 30.000 a R$ 60.000" },
