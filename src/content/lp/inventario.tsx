...
export const inventarioContent: LpContent = {
  ...
  formFields: [
    {
      id: "fase",
      label: "Em que fase está o inventário",
      type: "select",
      required: true,
      placeholder: "Selecione",
      options: [
        { value: "falecimento_recente", label: "Falecimento recente / ainda não iniciei" },
        { value: "aberto_andamento", label: "Inventário aberto em andamento" },
        { value: "travado", label: "Inventário travado" },
        { value: "preventivo", label: "Ninguém faleceu — planejamento preventivo" },
      ],
    },
    {
      id: "patrimonio_total",
      ...
      options: [
        ...
        { value: "nao_sei", label: "Ainda não sei o valor" },
      ],
    },
    {
      id: "composicao",
      label: "Como o patrimônio é composto (pode marcar mais de um)",
      type: "multiselect",
      required: true,
      options: [
        ...
        { value: "exterior", label: "Bens no exterior" },
    ...
    {
      id: "conflito",
      label: "Há risco de conflito entre herdeiros?",
      type: "select",
      required: true,
      placeholder: "Selecione",
      options: [
        { value: "sim", label: "Sim, conflito aberto" },
        { value: "talvez", label: "Talvez / há atritos" },
        { value: "nao", label: "Não, família alinhada" },
      ],
    },
    {
      id: "contato",
