...
export const saudeContent: LpContent = {
  ...
  formFields: [
    {
      id: "situacao_plano",
      label: "Situação com o plano",
      type: "select",
      required: true,
      placeholder: "O que aconteceu?",
      options: [
        { value: "negou_escrito", label: "O plano negou por escrito" },
        { value: "negou_verbal", label: "O plano negou verbalmente" },
        { value: "autorizou_nao_cumpre", label: "Autorizou mas não cumpre" },
        { value: "enrolando", label: "Está enrolando / sem resposta clara" },
        { value: "nao_pedi", label: "Ainda não pedi ao plano" },
      ],
    },
    {
      id: "tipo_cobertura",
      ...
      options: [
        ...
        { value: "medicamento_alto_custo", label: "Medicamento de alto custo" },
        { value: "uti", label: "UTI / internação" },
        { value: "home_care", label: "Home care" },
        { value: "cirurgia", label: "Cirurgia" },
        { value: "terapia_continuada", label: "Terapia continuada" },
    ...
    },
    {
      ...
      placeholder: "Selecione",
      options: [
        { value: "risco_vida", label: "Risco de vida / piora rápida" },
        { value: "ate_30_dias", label: "Precisa em até 30 dias" },
        { value: "sem_urgencia", label: "Sem urgência clínica" },
      ],
    },
    {
      id: "valor_plano",
