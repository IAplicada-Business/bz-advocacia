  ...
  return (
    <div className="lp-theme min-h-screen bg-lp-cream font-sans text-lp-ink antialiased">
      ...
      <section data-fold className="relative min-h-[100svh] overflow-hidden">
        ...
        />
        {/* Véu uniforme em toda a header — mesma opacidade da direita, sem L→R */}
        <div className="absolute inset-0 bg-lp-cream/20" />
        <div className="absolute inset-x-0 bottom-0 h-1/5 bg-gradient-to-t from-lp-cream/35 to-transparent" />
